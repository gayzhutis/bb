...
$package = 'msklad'; // Class name for generation
$suffix = 'msklad_'; // Suffix of tables.
...
//$manager->removeObjectContainer('mSkladItem');

//$manager->createObjectContainer('mSkladItem');
