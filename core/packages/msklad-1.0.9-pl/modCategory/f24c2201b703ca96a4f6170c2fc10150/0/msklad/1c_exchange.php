...
$syncuser = $modx->getObject('modSystemSetting',array('key' => 'msklad_1c_sync_login'));
$syncpass = $modx->getObject('modSystemSetting',array('key' => 'msklad_1c_sync_pass'));

if ( ($user != $syncuser->get('value') || $password != $syncpass->get('value')) ) {
